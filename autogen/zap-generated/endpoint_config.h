...
\
  ...
  { ZAP_SIMPLE_DEFAULT(330), 0x00000007, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* ColorTemperatureMireds */  \
  ...
  { ZAP_SIMPLE_DEFAULT(0x1F), 0x0000400A, 2, ZAP_TYPE(BITMAP16), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* ColorCapabilities */  \
  { ZAP_SIMPLE_DEFAULT(120), 0x0000400B, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* ColorTempPhysicalMinMireds */  \
  { ZAP_SIMPLE_DEFAULT(400), 0x0000400C, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* ColorTempPhysicalMaxMireds */  \
